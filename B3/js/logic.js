...
// and && -----------------------
console.warn(
    "And: Lấy giá trị false gần nhất -> nếu không có -> giá trị vế thứ 2"
);
console.log(v1 && v2 && "ABC"); // v1 la false gan nhat -> ""
console.log("A" && "B" && "C"); //khong co false -> tra ve xa nhat

// or || ----------------------
console.warn(
    "Or: Lấy gái trị True gần nhất -> nếu không có -> trả về giá trị vế thứ 2"
);
