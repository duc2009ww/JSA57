...
//duyet phan tu
//fori: hiển thị cả phần tử bị undèined (không có giá trị/ empty)
for (let index = 0; index < arr3.length; index++) {
    console.log(arr3[index]); //tra ve10 lan undefined
}
